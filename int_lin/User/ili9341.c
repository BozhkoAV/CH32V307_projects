...
#define ILI9341_RST_ON()	    (GPIOA->BSHR = GPIO_BSHR_BR4)
#define ILI9341_RST_OFF()	(GPIOA->BSHR = GPIO_BSHR_BS4)

#define ILI9341_DC_DATA()	(GPIOA->BSHR = GPIO_BSHR_BS2)
#define ILI9341_DC_CMD()	    (GPIOA->BSHR = GPIO_BSHR_BR2)

#define ILI9341_LED_ON()	    (GPIOA->BSHR = GPIO_BSHR_BS3)
#define ILI9341_LED_OFF()	(GPIOA->BSHR = GPIO_BSHR_BR3)

#define ILI9341_CS_ON()		(GPIOA->BSHR = GPIO_BSHR_BR1)
#define ILI9341_CS_OFF()	    (GPIOA->BSHR = GPIO_BSHR_BS1)
...
void ili9341_init(void)
{
	...
	//Set PA1, PA2, PA3 and PA4 as outputs, at max speed - 50Mhz
	GPIOA->CFGLR = (GPIOA->CFGLR & ~(GPIO_CFGLR_CNF1 | GPIO_CFGLR_CNF2 | GPIO_CFGLR_CNF3 | GPIO_CFGLR_CNF4 \
